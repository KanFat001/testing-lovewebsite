...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Services Section */}
      {/* <section className="py-24 lg:py-32 px-6 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extralight tracking-[0.05em] mb-8 uppercase">
              Services Offered
            </h2>
            <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
              Each service is thoughtfully crafted to honor your unique story, captured with the finest film stocks and
              developed with museum-quality care that ensures your memories will last for generations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="space-y-6 group">
              <div className="aspect-[4/3] relative overflow-hidden rounded-sm">
                <Image
                  ...
                  alt="Wedding photography - couple during ceremony"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              <h3 className="text-2xl font-light tracking-wide">Wedding Photography</h3>
              <p className="text-gray-300 leading-relaxed">
                Full-day coverage capturing every precious moment of your celebration, from the quiet getting-ready
                moments to the last dance under the stars.
              </p>
            </div>
            ...
            <div className="space-y-6 group">
              <div className="aspect-[4/3] relative overflow-hidden rounded-sm">
                <Image
                  src="/placeholder.svg?height=300&width=400"
                  alt="Engagement sessions - intimate couple portrait"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              <h3 className="text-2xl font-light tracking-wide">Engagement Sessions</h3>
              <p className="text-gray-300 leading-relaxed">
                Intimate portrait sessions that capture the essence of your relationship in beautiful, meaningful
                locations that tell your unique love story.
              </p>
            </div>
            ...
            <div className="space-y-6 group">
              <div className="aspect-[4/3] relative overflow-hidden rounded-sm">
                <Image
                  src="/placeholder.svg?height=300&width=400"
                  alt="Elopement packages - intimate ceremony"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              <h3 className="text-2xl font-light tracking-wide">Elopement Packages</h3>
              <p className="text-gray-300 leading-relaxed">
                Intimate ceremony coverage for couples choosing to celebrate their love in a more personal, meaningful
                way with just their closest loved ones.
              </p>
            </div>
            ...
            <div className="space-y-6 group">
              <div className="aspect-[4/3] relative overflow-hidden rounded-sm">
                <Image
                  src="/placeholder.svg?height=300&width=400"
                  alt="Destination weddings - scenic location"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              <h3 className="text-2xl font-light tracking-wide">Destination Weddings</h3>
              <p className="text-gray-300 leading-relaxed">
                Worldwide travel to document your love story against the backdrop of your dream destination, from
                mountain peaks to ocean shores.
              </p>
            </div>
            ...
            <div className="space-y-6 group">
              <div className="aspect-[4/3] relative overflow-hidden rounded-sm">
                <Image
                  src="/placeholder.svg?height=300&width=400"
                  alt="Film workshops - teaching photography"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              <h3 className="text-2xl font-light tracking-wide">Film Workshops</h3>
              <p className="text-gray-300 leading-relaxed">
                Educational sessions for photographers wanting to master the art, technique, and business of
            ...
            <div className="space-y-6 group">
              <div className="aspect-[4/3] relative overflow-hidden rounded-sm">
                <Image
                  src="/placeholder.svg?height=300&width=400"
                  alt="Editorial work - fashion photography"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              <h3 className="text-2xl font-light tracking-wide">Editorial & Commercial</h3>
              <p className="text-gray-300 leading-relaxed">
                Fashion, lifestyle, and commercial photography that brings the distinctive, timeless aesthetic of film
